        ...
        this.renderOneInputField = (_, index) => {
            ...
            return (<View pointerEvents="none" 
                ...
                <TextInput testID="textInput"
                 ...
                 style={selectedIndex === index ? [defaultTextFieldStyle, codeInputFieldStyle, codeInputHighlightStyle] :digits.length >= index+1 ? [defaultTextFieldStyle, codeInputFieldStyle, codeInputHighlightStyle] : [defaultTextFieldStyle, codeInputFieldStyle]} ref={ref => { this.fields[index] = ref; }} onChangeText={text => {
                this.handleChangeText(index, text);
