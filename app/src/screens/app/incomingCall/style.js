...
const Styles = StyleSheet.create({
  ...
  img:{ height: DEVICE_HEIGHT, width: DEVICE_WIDTH },
  name:{ flex: 0.3, justifyContent: 'center', alignItems: 'center' },
  callbtn:{ flex: 0.5, alignSelf: 'center', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', width: DEVICE_WIDTH * 0.8 },
  btn:{ height: DEVICE_WIDTH * 0.22, width: DEVICE_WIDTH * 0.22 },
  amount: {
